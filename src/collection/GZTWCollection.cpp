...
namespace firtex
{
	...
	{	
		CGZTWCollection::CGZTWCollection(const tchar* dir)
			:CTWCollection(dir)
		{
		}

		CGZTWCollection::CGZTWCollection(const tchar* dir,CIndexWriter* pWriter)
			:CTWCollection(dir,pWriter)
		{
		}
		CGZTWCollection::~CGZTWCollection(void)
		{
		}
		void CGZTWCollection::indexDocs(const tchar* directory)
		{			
